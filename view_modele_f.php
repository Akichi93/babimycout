                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Ajouter modele <small>femme</small></h4>
                        </div>
                   ...
                   <div class="form-group col-md-6"><!-- form-group Begin -->
                      ...
                      <select name="s_cate" class="form-control"><!-- form-control Begin -->
                             ...
                             <?php 
                              ...
                              $get_taille = "SELECT * from sous_categorie WHERE id_cate = 2 ";
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                         <?php 
                                ...
                                $get_model = "SELECT * FROM model  WHERE id_cate = 2 ORDER BY id_model DESC"; 
...
foreach($checkbox1 as $chk1)  
   {  
    ...
    $insert_modele = "INSERT into model (nom_model,image_un,image_deux,image_trois,image_quatre,image_cinq,desc_model,prix_model,prix_couture,statut,qtes,taille,coudre,date_create,id_cate,id_scate) values ('$nom_model','$image_un','$image_deux','$image_trois','$image_quatre','$image_cinq','$desc_model','$prix_model','$prix_couture','0','$qtes','".$taille."','$chk',NOW(),'2','".$s_cate."')";
   ...
   $sql = "INSERT INTO log (admin_id, action, type, date_create, date_update) VALUES ('$_id', '$admin_email vient d\'ajouter un modele femme', 'Ajout', NOW(), NOW())";
   $run_sql =  mysqli_query($con,$sql);
    
    if($run_sql){
        
        echo "<script>window.open('view_modele_f.php','_self')</script>";
