          ...
          <div class="">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Ajouter modele enfant</h4>
                        </div>
                   ...
                   <div class="form-group col-md-6"><!-- form-group Begin -->
                      ...
                      <select name="s_cate" class="form-control"><!-- form-control Begin -->
                             ...
                             <?php 
                              ...
                              $get_taille = "SELECT * from sous_categorie WHERE id_cate = 3 ";
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Listes des modeles<small> Enfants</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Description</th>
                          <?php  if (isset($result1['f747e892']) || isset($result1['8e425576']))  {?>
                          <th>Action</th>
                          <?php } ?>
                        </tr>
                      </thead>
                      ...
                      <tbody>
                        <?php 
                               ...
                               $get_model = "SELECT * FROM model  WHERE id_cate = 3 ORDER BY id_model DESC"; 
                                ...
                                while($row_model=mysqli_fetch_array($run_model)){
                                    ...
                                    $image_deux = $row_model['image_deux'];

                                    $image_trois = $row_model['image_trois'];

                                    $image_quatre = $row_model['image_quatre'];

                                    $image_cinq = $row_model['image_cinq'];
                                    ...
                                    $id_scate = $row_model['id_scate'];

                                    //$nom_scate = $row_model['nom_scate'];
...
?> </td>
                                ...
                                <td> 
                                     ...
                                     <a href="delete_modele.php?id=<?php echo $id_model; ?>&page=view_modele_e.php" onclick="return confirm('Supprimer le modele <?php echo $nom_model; ?>');">
                                   ...
                                   <?php } ?>
                                    <?php  if (isset($result1['f747e892']))  {?>
                                     ...
                                     <a href="edit_modele.php?id=<?php echo $id_model; ?>&page=view_modele_e.php">    
...
foreach($checkbox1 as $chk1)  
   {  
    ...
    $insert_modele = "INSERT into model (nom_model,image_un,image_deux,image_trois,image_quatre,image_cinq,desc_model,prix_model,prix_couture,statut,qtes,taille,coudre,date_create,id_cate,id_scate) values ('$nom_model','$image_un','$image_deux','$image_trois','$image_quatre','$image_cinq','$desc_model','$prix_model','$prix_couture','0','$qtes','".$taille."','$chk',NOW(),'3','".$s_cate."')";
   ...
   $sql = "INSERT INTO log (admin_id, action, type, date_create, date_update) VALUES ('$_id', '$admin_email vient d\'ajouter un modele enfant', 'Ajout', NOW(), NOW())";
   $run_sql =  mysqli_query($con,$sql);
             
    
    if($run_sql){
        
        echo "<script>window.open('view_modele_e.php','_self')</script>";
