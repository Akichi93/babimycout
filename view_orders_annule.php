          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Liste des commandes <small>Annulés</small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php 
                                ...
                                $get_commande = "SELECT * FROM commande INNER JOIN user ON commande.id_user = user.id_user INNER JOIN model ON commande.id_model = model.id_model  WHERE commande.statut = 2 ORDER BY id_livre DESC ";
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td> 
                                     ...
                                     <a href="delete_order.php?id=<?php echo $id_livre; ?>&page=view_orders_annulé.php?">
